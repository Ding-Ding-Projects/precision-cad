...
class PreferencesStoreTests final : public QObject {
    Q_OBJECT
private slots:
 void persistsValidState(); void rejectsInvalidWithoutChange(); void corruptionRetainsDefaults(); void resetPreservesCorruptEvidence(); void writerLockPreservesMemory(); void exportOmitsVoiceIds(); void staleWriterRejected(); void vocabularyLoadsAndClears(); void vocabularyRejectsDuplicateDecodedKey();
};
