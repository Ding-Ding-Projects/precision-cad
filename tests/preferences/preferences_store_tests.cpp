...
class PreferencesStoreTests final : public QObject {
    Q_OBJECT
private slots:
 void persistsValidState(); void rejectsInvalidWithoutChange(); void corruptionRetainsDefaults(); void writerLockPreservesMemory(); void exportOmitsVoiceIds();
};
...
QTEST_MAIN(PreferencesStoreTests)
